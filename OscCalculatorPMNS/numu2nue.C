{
    ...
    leg->Draw();
    if(!isLBNE)canvas1->SaveAs(isNOVA?"plots/nova_threeflav_exact_probability_matter_numu2nue.eps":"plots/t2k_threeflav_exact_probability_matter_numu2nue.eps");
        else canvas1->SaveAs("plots/lbne_threeflav_exact_probability_matter_numu2nue.eps");
