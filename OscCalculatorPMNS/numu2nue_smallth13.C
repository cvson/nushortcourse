{
    ...
    double myTheta13=0.1;//TMath::ASin(TMath::Sqrt(0.04))/2
    ...
    leg->Draw();
    if(!isLBNE)canvas1->SaveAs(isNOVA?"plots/nova_threeflav_exact_probability_matter_numu2nue_smallth13.eps":"plots/t2k_threeflav_exact_probability_matter_numu2nue_smallth13.eps");
        else canvas1->SaveAs("plots/lbne_threeflav_exact_probability_matter_numu2nue_smallth13.eps");
