...
void checkNoSmearing_all_final(){
    ...
    Bool_t isComparetoExperimentalPred = false;
    TFile *pfile = new TFile("eventrate_all_t2k2_final_nosmear.root","READ");
    ...
    TH1D* hglobes_nosmear_fhc_dis_numu = (TH1D*)hrule2_sig[0]->Clone("hglobes_nosmear_fhc_dis_numu");
    leg0->AddEntry(hglobes_nosmear_fhc_dis_numu, "GloBES, #nu_{#mu}#rightarrow #nu_{#mu} CCQE", "l");
    ci = TColor::GetColor(colorcode[1]);
    hglobes_nosmear_fhc_dis_numu->SetLineColor(ci);
    hglobes_nosmear_fhc_dis_numu->SetLineStyle(7);
    hglobes_nosmear_fhc_dis_numu->Rebin(4);
    hglobes_nosmear_fhc_dis_numu->Draw("hist same");
    ...
    leg0->Draw();
    gPad->Print(isComparetoExperimentalPred?"t2k_fhc_dis_comp_nosmear_final.pdf":"t2k_fhc_dis_comp_nosmear_final_globesonly.pdf");
    delete leg0;
    ...
    TH1D* hglobes_nosmear_rhc_dis_numub = (TH1D*)hrule3_sig[0]->Clone("hglobes_nosmear_rhc_dis_numub");
    ci = TColor::GetColor(colorcode[1]);
    hglobes_nosmear_rhc_dis_numub->SetLineColor(ci);
    hglobes_nosmear_rhc_dis_numub->SetLineStyle(7);
    
    leg1->AddEntry(hrate_all_rule[3], "GloBES, Total", "l");
    leg1->AddEntry(hglobes_nosmear_rhc_dis_numub, "GloBES, #bar{#nu}_{#mu}#rightarrow #bar{#nu}_{#mu} CCQE", "l");
    hrate_all_rule[3]->SetLineColor(1);
    hrate_all_rule[3]->SetLineStyle(7);
    hrate_all_rule[3]->Rebin(4);
    hrate_all_rule[3]->Draw("hist same");
    hglobes_nosmear_rhc_dis_numub->Rebin(4);
    hglobes_nosmear_rhc_dis_numub->Draw("hist same");
    hglobes_nosmear_rhc_dis_numub->SetLineWidth(2);
    ci = TColor::GetColor(colorcode[2]);
    ...
    leg1->Draw();
    gPad->Print(isComparetoExperimentalPred?"t2k_rhc_dis_comp_nosmear_final.pdf":"t2k_rhc_dis_comp_nosmear_final_globesonly.pdf");
    delete leg1;
    ...
    leg2->Draw();
    gPad->Print(isComparetoExperimentalPred?"t2k_fhc_app_comp_nosmear_final.pdf":"t2k_fhc_app_comp_nosmear_final_globesonly.pdf");
    delete leg2;
    ...
    leg3->Draw();
    gPad->Print(isComparetoExperimentalPred?"t2k_rhc_app_comp_nosmear_final.pdf":"t2k_rhc_app_comp_nosmear_final_globesonly.pdf");
    delete leg3;
