...
//without smearing
/*char MYFILE[]="t2k2_final_nosmear_sensi_cp_simple.root";
 char AEDLFILE[]="t2k2_final_nosmear.glb";*/
char MYFILE[]="t2k2_final_wsmear_sensi_cp_simple.root";
...
{ 
    ...
    for (y = -1. ; y < 1.0 ; y=y+deltastep){
        ...
        printf("Computing w/ dcp=-pi/2 true: %d/%d  points \n",count, NDELTApoint) ;
        count++;
