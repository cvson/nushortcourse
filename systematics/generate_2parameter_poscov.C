...
void generate_2parameter_poscov(){
    gROOT->ProcessLine(".x ../rootlogon.C");
    ofstream opfile("data4histogram_2d_poscov.txt");
...
void plot_histogram_2d(){
    ifstream cfile("data4histogram_2d_poscov.txt");
    string dummyline;
    ...
    //hhisto->Draw("colz");
    c1->Print("basic_histogram_2d_10k_poscov.eps");
