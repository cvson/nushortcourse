...
void plot_histogram_2d(){
    ifstream cfile("data4histogram_2d_negcov.txt");
    string dummyline;
    ...
    //hhisto->Draw("colz");
    c1->Print("basic_histogram_2d_10k_negcov.eps");
    
    center_pad->cd();
    hhisto->Draw("COLZ");
    c1->Modified();
     c1->Print("basic_histogram_2d_10k_colz_negcov.eps");
    ...
    gPad->Print("systematics_effect_negcov.eps");
