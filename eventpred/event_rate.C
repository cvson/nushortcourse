...
void event_rate(){
    ...
    //you also needs to define efficity detection, detector is not perfect
    ...
    heventrate4show[0][0]->GetXaxis()->SetTitle("#nu Energy [GeV]");
    heventrate4show[0][0]->GetXaxis()->SetTitleOffset(0.9);
    //reduce the label size
    heventrate4show[0][0]->GetXaxis()->SetTitleSize(heventrate4show[0][0]->GetXaxis()->GetLabelSize()*0.7);
    heventrate4show[0][0]->GetYaxis()->SetTitleSize(heventrate4show[0][0]->GetYaxis()->GetLabelSize()*0.7);
    heventrate4show[0][0]->GetXaxis()->SetLabelSize(heventrate4show[0][0]->GetXaxis()->GetLabelSize()*0.7);
    heventrate4show[0][0]->GetYaxis()->SetLabelSize(heventrate4show[0][0]->GetYaxis()->GetLabelSize()*0.7);
    ...
    leg0->Draw();
    gPad->Print("t2kexp_eventrate_1tonH20_neardet.eps");
    ...
    heventrate4show[1][0]->GetXaxis()->SetTitle("#nu Energy [GeV]");
    heventrate4show[1][0]->GetXaxis()->SetTitleOffset(0.9);
    //reduce the label size
    heventrate4show[1][0]->GetXaxis()->SetTitleSize(heventrate4show[1][0]->GetXaxis()->GetLabelSize()*0.7);
    heventrate4show[1][0]->GetYaxis()->SetTitleSize(heventrate4show[1][0]->GetYaxis()->GetLabelSize()*0.7);
    heventrate4show[1][0]->GetXaxis()->SetLabelSize(heventrate4show[1][0]->GetXaxis()->GetLabelSize()*0.7);
    heventrate4show[1][0]->GetYaxis()->SetLabelSize(heventrate4show[1][0]->GetYaxis()->GetLabelSize()*0.7);
